...
public enum Permission implements IPermissionEnum {
    ...
    BUILD_PSD("train.build.psd", PermissionDefault.OP, "The player can build PSD on train stations"),
    ...
    BUILD_ROUTE("train.build.route", PermissionDefault.OP, "The player can build a sign that sets a train's final destination."),
    BUILD_FDEST("train.build.fdest", PermissionDefault.OP, "The player can build a sign that sets a train's final destination after it reverses."),
