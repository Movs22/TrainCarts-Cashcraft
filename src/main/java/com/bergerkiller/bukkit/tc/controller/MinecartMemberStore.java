...
public abstract class MinecartMemberStore {
    ...
    public static MinecartMember<?> spawn(TrainCarts plugin, Location at, EntityType type) {
        return spawn(plugin, at, type, null, null);
    }
    
    public static MinecartMember<?> spawn(TrainCarts plugin, Location at, EntityType type, String destination) {
        return spawn(plugin, at, type, null, null);
    }
    
    public static MinecartMember<?> spawn(TrainCarts plugin, Location at, EntityType type, ConfigurationNode config) {
    	   return spawn(plugin, at, type, null, config);
    }
    public static MinecartMember<?> spawn(TrainCarts plugin, Location at, EntityType type, String destination, ConfigurationNode config) {
        ...
        if(destination != null) {
        	result.getProperties().setDestination(destination);
        }
        return result;
    }
