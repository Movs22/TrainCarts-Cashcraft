...
public class SpawnableMember {
    ...
    public MinecartMember<?> spawn(Location spawnLoc) {
    	return spawn(spawnLoc, null);
    }
    public MinecartMember<?> spawn(Location spawnLoc, String destination) {
        return MinecartMemberStore.spawn(this.getPlugin(), spawnLoc, getEntityType(), destination, this.config);
    }
